    ...
    return JSONResponse(
        {
            "allocation": {
                ...
                "cash": {"total": 9699.41, "pct": 97.0},
                "other": {"total": 0.0, "pct": 0.0},
            },
            "diversification": {
            ...
            "rebalancing": {
                "target_allocation": {"crypto": 10.0, "cash": 90.0},
                "current_drift": {"crypto": 7.0, "cash": 87.0},
    ...
    return JSONResponse(
        {
            ...
            "value_at_risk": {"var_95_daily": 0.0, "var_99_daily": 0.0, "cvar_95": 0.0},
            "stress_test": {
    ...
    return JSONResponse(
        {
            ...
            "by_sector": {"technology": 3.0, "other": 0.0},
            "by_geography": {"global": 3.0, "us": 0.0, "other": 0.0},
